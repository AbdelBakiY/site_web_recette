...
// Correction: Utiliser $_SESSION['email'] au lieu de $email qui n'est pas défini
if ($Logged) {
...
if (isset($_GET['lang'])) {
    $_SESSION['lang'] = in_array($_GET['lang'], ['fr', 'en']) ? $_GET['lang'] : 'fr';
}
                    ...
                    <?php if ($Logged): ?>
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button"
                                ...
                                <?= htmlspecialchars($utilisateurConnecte['prenom']) . " " . htmlspecialchars($utilisateurConnecte['nom'])
                                    ?>
                            </a>
                            <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="userDropdown">
                                <li><a class="dropdown-item" href="profil.php"><i class="fas fa-user me-2"></i>Profil</a>
                                </li>
                        </li>
                        <li>
